...
public class OtherShapes1 extends Applet{
    int X,Y, scale = 7;
    int convertX(int x) {
        return X + x * scale;
    }
    ...
    public void paint(Graphics g){
        ...
        midpointCircle(g, -20, -20, 6);

        g.setColor(Color.green);
        midpointEllipse(g, 0, 0, 50,35);

        g.setColor(new Color(52, 152, 219));
        midpointCircle(g, 20, -17, 4);

        g.setColor(Color.red);
        midpointCircle(g, -12, 22, 5);  

        g.setColor(new Color(142, 68, 173));
        midpointCircle(g, -27, 6, 2);  

        g.setColor(Color.black);
        midpointCircle(g, 0, 0, 3);

        g.setColor(new Color(241, 196, 15));
        midpointCircle(g, 20, 0, 5);

        g.setColor(new Color(211, 84, 0));
        midpointCircle(g, -20, 0, 4);
    }
}

/* 
<applet code="OtherShapes1" width="900" height="900"> </applet> 
*/