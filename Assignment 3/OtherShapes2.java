...
public class OtherShapes2 extends Applet{
    int X,Y, scale = 7;
    int convertX(int x) {
        return X + x * scale;
    }
    ...
    public void paint(Graphics g){
        ...
        midpointEllipse(g, 0, 0, 35,28);

        g.setColor(Color.black);
        DDALine(g, 20, 5, 40, 20);
        DDALine(g, -20, 5, -40, 20);
        DDALine(g, 20, -5, 40, -20);
        DDALine(g, -20, -5, -40, -20);
        ...
        DDALine(g, 8, 14, 20, 35);
        DDALine(g, -8, 14, -20, 35);
        DDALine(g, 8, -14, 20, -35);
        DDALine(g, -8, -14, -20, -35);

        g.setColor(new Color(181, 52, 113));
        DDALine(g, 18, 10, 30, 30);
        DDALine(g, -18, 10, -30, 30);
        DDALine(g, 18, -10, 30, -30);
        DDALine(g, -18, -10, -30, -30);
    }
...
/* 
<applet code="OtherShapes2" width="900" height="900"> </applet> 
*/